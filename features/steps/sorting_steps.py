...
def step_verify_sorted_asc(context):
    ...
    assert context.search_page.is_sorted_by_price_ascending(), \
...
def step_verify_sorted_desc(context):
    ...
    time.sleep(1)  # Wait for page to stabilize
    assert context.search_page.is_sorted_by_price_descending(), \
...
def step_verify_still_sorted_asc(context):
    ...
    time.sleep(1)
    assert context.search_page.is_sorted_by_price_ascending(), \
        "Sorting did not persist after page refresh"
